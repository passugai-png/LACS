 ...
 * @version 20070312
 */
public abstract class LACSSessionDBModelBase extends LACSModelBase {
	...
	protected DBConnectionInfo getConnectionInfo() {
		...
		connectionInfo.setDataSource("java:comp/env/jdbc/" + Command.init(((String)(super.getRequest().getSession().getAttribute("DataSource"))), "ORADB"));
