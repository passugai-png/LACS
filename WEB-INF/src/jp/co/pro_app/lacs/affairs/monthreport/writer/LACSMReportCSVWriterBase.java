 ...
 * @version 20080409
 */
public abstract class LACSMReportCSVWriterBase {
	 ...
	 *            DB接続
	 */
	public LACSMReportCSVWriterBase(LACSCommonBean piCommonBean, LACSModelBase piModel, Connection piCon) {
	 ...
	 *                実行例外
	 */
	protected abstract String makeCSV(LACSMReportBean piReportBean, String piDateMode, ServletContext piContext) throws Exception;
