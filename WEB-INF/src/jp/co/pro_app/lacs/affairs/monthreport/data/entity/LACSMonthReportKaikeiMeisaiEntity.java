...
/**
 * 月次帳票出力画面 ： リース会計明細基準書 Entity.
 * 
 * @author arai
 * @version 20210819
 */
public class LACSMonthReportKaikeiMeisaiEntity extends LACSMReportEntityBase {
	 ...
	 *            帳票出力Bean
	 */
	public LACSMonthReportKaikeiMeisaiEntity(DBModelBase piModel, LACSCommonBean piCommonBean, LACSMReportBean piReportBean) throws SQLException {
	...
	protected void makeSQL() {
		...
		// 20210901 ブレイクキー追加 start
		super.sql.append("  RPAD(KEI_NO, 20, ' ') BRAKE_KEY0 " + "\n");
		// 20210901 ブレイクキー追加 end
		...
		//super.sql.append("		AND KEI.KEI_NO = '" + this.getKeiyakuNo() + "' \n");
		...
		super.sql.append("		WHERE KEI.LU_COSMOS_CD = '" + this.leasCompanyCode + "'  \n");
		super.sql.append("		AND KEI.KEI_NO = '" + this.keiyakuNo + "' \n");
		//super.sql.append("         AND KEI.KEI_NO = '" + this.getKeiyakuNo(this.keiyakuNo) + "' \n");
		...
		//super.sql.append("         AND BASE.KEI_NO = '" + this.getKeiyakuNo(this.keiyakuNo) + "' \n");
		...
		//super.sql.append("         WHERE KEI.KEI_NO = '" + this.getKeiyakuNo(this.keiyakuNo) + "' \n");
		super.sql.append("		UNION ALL \n");
		super.sql.append("		SELECT \n");
		super.sql.append("			KEI.LU_COSMOS_CD  \n");
		super.sql.append("			,SKK.LC_CD  \n");
