...
import jp.co.pro_app.lacs.affairs.monthreport.data.entity.LACSMReportShiwakeGensenEntity;
 ...
 * @version 20080409
 */
public class LACSMReportCSVShiwakeGensenWriter extends LACSMReportCSVWriterBase {
	 ...
	 *            DB接続
	 */
	public LACSMReportCSVShiwakeGensenWriter(LACSCommonBean piCommonBean, LACSModelBase piModel, Connection piCon) {
	...
	public String makeCSV(LACSMReportBean piReportBean, String piDateMode, ServletContext piContext) throws Exception {
		LACSMReportShiwakeGensenEntity reportEntity = new LACSMReportShiwakeGensenEntity(super.model, this.commonBean, piReportBean);
		String fileName = "";

		File tmpFile = null; // 出力先ファイル

		String[] header = new String[]{ "作成日", "対象期間開始", "対象期間終了", "表示用契約番号", "物件番号", "物件番号枝番", "固定資産科目コード", "固定資産科目名称", "開示先コード", "開示先", "リース取引分類コード", "リース取引分類名称", "契約日", "検収日", "満了日", "中途解約日", "契約期間", "経過月数", "対象会計基準コード", "賃貸借フラグ", "耐用年数", "物件名", "利息相当額配分方法コード", "利息相当額配分方法名称", "賦金展開方法コード", "賦金展開方法名称", "維持管理費重要性区分", "維持管理費重要性区分名称", "役務提供費重要性区分", "役務提供費重要性区分名称", "賦金展開端数調整方法コード", "賦金展開端数調整方法名称", "減価償却方法コード", "減価償却方法名称", "減価償却端数調整方法コード", "減価償却端数調整方法名称", "リース料総額税抜", "リース料消費税", "割引現在価値", "割引計算利子率", "見積現金購入価格", "うち残価保証額", "取得価格相当額", "利息計算利子率", "支払利息相当額総額", "月額リース料税抜", "月額リース料消費税", "月額均等償却費相当額", "当期支払リース料", "当期支払リース料消費税", "当期支払リース料うちリース債務返済額", "当期支払リース料うち利息相当額", "当期支払リース料うち登録諸費用（課税）相当額", "当期支払リース料うち登録諸費用（非課税）相当額", "当期支払リース料うち取得税相当額", "当期支払リース料うち自動車税相当額", "当期支払リース料うち重量税相当額", "当期支払リース料うち自賠責保険相当額", "当期支払リース料うち任意保険相当額", "当期支払リース料うちリサイクル料管理費相当額", "当期支払リース料うち動総相当額", "当期支払リース料うち固税相当額", "当期支払リース料うちその他原価相当額", "当期支払リース料うち保守料相当額", "当期減価償却費相当額", "支払リース料累計額", "支払リース料消費税累計額", "支払リース料うちリース債務返済額累計額", "支払リース料うち利息累計額相当額", "支払リース料うち登録諸費用（課税）累計額相当額", "支払リース料うち登録諸費用（非課税）累計額相当額", "支払リース料うち取得税累計額相当額", "支払リース料うち自動車税累計額相当額", "支払リース料うち重量税累計額相当額", "支払リース料うち自賠責保険累計額相当額", "支払リース料うち任意保険累計額相当額", "支払リース料うちリサイクル料管理費累計額相当額", "支払リース料うち動総累計額相当額", "支払リース料うち固税累計額相当額", "支払リース料うちその他原価累計額相当額", "支払リース料うち保守料累計額相当額", "減価償却累計額相当額", "支払リース料残高（一年内）", "支払リース料消費税残高（一年内）", "支払リース料うちリース債務返済額（1年内合計）", "支払リース料うち利息相当額（1年内合計）", "支払リース料うち登録諸費用（課税）相当額（1年内合計）", "支払リース料うち登録諸費用（非課税）相当額（1年内合計）", "支払リース料うち取得税相当額（1年内合計）", "支払リース料うち自動車税相当額（1年内合計）", "支払リース料うち重量税相当額（1年内合計）", "支払リース料うち自賠責保険相当額（1年内合計）", "支払リース料うち任意保険相当額（1年内合計）", "支払リース料うちリサイクル料管理費相当額（1年内合計）", "支払リース料うち動総相当額（1年内合計）", "支払リース料うち固税相当額（1年内合計）", "支払リース料うちその他原価相当額（1年内合計）", "支払リース料うち保守料相当額（1年内合計）", "減価償却相当額（1年内合計）", "支払リース料残高（一年超）", "支払リース料消費税残高（一年超）", "支払リース料うちリース債務返済額（1年超合計）", "支払リース料うち利息相当額（1年超合計）", "支払リース料うち登録諸費用（課税）相当額（1年超合計）", "支払リース料うち登録諸費用（非課税）相当額（1年超合計）", "支払リース料うち取得税相当額（1年超合計）", "支払リース料うち自動車税相当額（1年超合計）", "支払リース料うち重量税相当額（1年超合計）", "支払リース料うち自賠責保険相当額（1年超合計）", "支払リース料うち任意保険相当額（1年超合計）", "支払リース料うちリサイクル料管理費相当額（1年超合計）", "支払リース料うち動総相当額（1年超合計）", "支払リース料うち固税相当額（1年超合計）", "支払リース料うちその他原価相当額（1年超合計）", "支払リース料うち保守料相当額（1年超合計）", "減価償却相当額（1年超合計）", "支払リース料残高（合計）", "支払リース料消費税残高（合計）", "支払リース料うちリース債務返済額（１年内１年超合計）", "支払リース料うち利息相当額（１年内１年超合計）", "支払リース料うち登録諸費用（課税）相当額（１年内１年超合計）", "支払リース料うち登録諸費用（非課税）相当額（１年内１年超合計）", "支払リース料うち取得税相当額（１年内１年超合計）", "支払リース料うち自動車税相当額（１年内１年超合計）", "支払リース料うち重量税相当額（１年内１年超合計）", "支払リース料うち自賠責保険相当額（１年内１年超合計）", "支払リース料うち任意保険相当額（１年内１年超合計）", "支払リース料うちリサイクル料管理費相当額（１年内１年超合計）", "支払リース料うち動総相当額（１年内１年超合計）", "支払リース料うち固税相当額（１年内１年超合計）", "支払リース料うちその他原価相当額（１年内１年超合計）", "支払リース料うち保守料相当額（１年内１年超合計）", "減価償却相当額（１年内１年超合計）" };
		...
		try {
			...
			tmpFile = File.createTempFile("csv14_", ".csv", scratchDirectory);
