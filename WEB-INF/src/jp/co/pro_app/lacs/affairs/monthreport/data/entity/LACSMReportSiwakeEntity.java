 ...
 * @version 20080415
 */
public class LACSMReportSiwakeEntity extends LACSMReportEntityBase {
	 ...
	 *            帳票出力Bean
	 */
	public LACSMReportSiwakeEntity(DBModelBase piModel, LACSCommonBean piCommonBean, LACSMReportBean piReportBean) {
	...
	protected void makeSQL() {
		...
		// 2021/10/18 arai 追加 START
		super.sql.append("SELECT * FROM ( \n");
		// 2021/10/18 arai 追加 end
		...
		super.sql.append("	,DECODE(TAISHO_AC_KIJYUN_CD || CTSHK_FLG || JYSI_UM || KEIJ_YM,lag(TAISHO_AC_KIJYUN_CD || CTSHK_FLG ||JYSI_UM || KEIJ_YM) over(partition by LU_NM order by TAISHO_AC_KIJYUN_CD,CTSHK_FLG,JYSI_UM,KEIJ_YM,SWK_KBN,SIWAKE_GYO),'',KEIJ_YM) KEIJ_YM \n");
		...
		super.sql.append("  ,JYSI_UM_CD \n");
		super.sql.append("  ,CASE WHEN JYSI_UM_CD = '1' THEN 'あり' ELSE 'なし' END JYSI_UM \n");
		// 2021/03/01 arai 重要性有無の追加 end		
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  ,KEIJ_YM SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		...
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  ,BASE.KEIJ_YM SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		...
		// 2021/03/01 arai 重要性有無の追加 start
		super.sql.append("  ,BASE.JYSI_UM_CD \n");
		super.sql.append("  ,CASE WHEN BASE.JYSI_UM_CD = '1' THEN 'あり' ELSE 'なし' END JYSI_UM \n");
		// 2021/03/01 arai 重要性有無の追加 end
		...
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  		,RSK.KEIJ_YM SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		...
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  		,SKK.KEIJ_YM SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		...
		// 2021/03/01 arai 重要性有無の追加 start
		super.sql.append("       BASE.JYSI_UM_CD \n");
		super.sql.append("      ,CASE WHEN BASE.JYSI_UM_CD = '1' THEN 'あり' ELSE 'なし' END  \n");
		// 2021/03/01 arai 重要性有無の追加 end
		super.sql.append("		,BASE.LU_COSMOS_CD  \n");
		super.sql.append("		,BASE.LC_CD  \n");
		super.sql.append("		,BASE.CTSHK_FLG  \n");
		...
		super.sql.append("		,BASE.KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  	,BASE.SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		super.sql.append("		,BASE.SWK_KBN  \n");
		super.sql.append("		,BASE.SIWAKE_GYO  \n");
		super.sql.append("		,BASE.KR_KNJ_KMK_CD  \n");
		...
		// 2021/03/01 arai 重要性有無の追加 start
		super.sql.append("  ,DETAILS.JYSI_UM_CD \n");	
		// 2021/03/01 arai 重要性有無の追加 end
		super.sql.append("	,DETAILS.KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 START
		super.sql.append("  ,DETAILS.SORT_KEIJ_YM \n");
		// 2021/10/19 ソート用の計上年月 追加 END
		super.sql.append("	,DETAILS.SWK_KBN  \n");
		super.sql.append("	,DETAILS.SIWAKE_GYO \n");
// 2020/05/22 ADD SQL START
		super.sql.append("	) \n");
		super.sql.append("	UNION ALL  \n");
		super.sql.append("	SELECT * FROM (  \n");
		super.sql.append("	    SELECT   A.CREATE_DATE   \n");
		super.sql.append("	           , MAX(A.TERM_FROM)  \n");
		super.sql.append("	           , MAX(A.TERM_TO)  \n");
		super.sql.append("	           , MAX(A.LEASE_USER_NM) \n");
		super.sql.append("	           , MAX(A.LEASE_COMPANY_NM) \n");
		super.sql.append("             , MAX(A.LEASE_COMPANY_ZIP)  \n");
		super.sql.append("	           , MAX(A.LEASE_COMPANY_ADDR1) \n"); 
		super.sql.append("	           , MAX(A.LEASE_COMPANY_ADDR2) \n");
		super.sql.append("	           , MAX(A.TAISHO_AC_KIJYUN_CD) \n");
		super.sql.append("	           , MAX(A.TAISHO_AC_KIJYUN_NM) \n");
		super.sql.append("	           , MAX(A.CTSHK_FLG) \n");
		super.sql.append("	           , MAX(A.CTSHK_FLG_NM) \n");
		super.sql.append("	           , MAX(A.KEIJ_YM) \n");
		super.sql.append("             , KR_KNJ_KMK_CD \n");
		super.sql.append("	           , KR_KNJ_KMK_NM \n");
		super.sql.append("	           , TO_CHAR(NVL(SUM(KRKT_AMT),'')) \n");
		super.sql.append("	           , KS_KNJ_KMK_CD \n");
		super.sql.append("	           , KS_KNJ_KMK_NM \n");
		super.sql.append("	           , TO_CHAR(NVL(SUM(KSKT_AMT),'') ) \n");
		super.sql.append("	           , '9' MESI_KBN \n");
		super.sql.append("             , MAX(SWK_KBN) \n");
		super.sql.append("             , MAX(SIWAKE_GYO) \n");
		// 2021/03/01 arai 重要性有無の追加 start
		super.sql.append("             , A.JYSI_UM_CD \n");
		super.sql.append("             , A.JYSI_UM \n");		
		super.sql.append("             , MAX(A.KEIJ_YM) SORT_KEIJ_YM \n");
		// 2021/03/01 arai 重要性有無の追加 end
		super.sql.append("      FROM ( \n");
// 2020/05/22 ADD SQL 以下上記のSQLを記載 START
		super.sql.append("SELECT \n");
		super.sql.append("	 to_char(CURRENT_DATE,'yyyymmdd') CREATE_DATE \n");
		super.sql.append("	,'" + this.taisyouFrom + "' TERM_FROM \n");
		super.sql.append("	,'" + this.taisyouTo + "' TERM_TO \n");
...
// 2020/05/22 ADD SQL 以下上記のSQLを記載 END
		super.sql.append("   	  ) A \n");
		super.sql.append(" 	 GROUP BY \n"); 
		// 2021/03/01 arai 重要性有無の追加 start
		super.sql.append("              JYSI_UM_CD \n");
		...
		super.sql.append("   ) \n");		
		// 2021/10/18 arai 追加 start
		//super.sql.append(" ) ORDER BY DECODE(JYSI_UM_CD,0,1,1,2),TAISHO_AC_KIJYUN_CD,CTSHK_FLG,DECODE(MESI_KBN,0,1,9,2) \n");
		super.sql.append(" ) ORDER BY TAISHO_AC_KIJYUN_CD,DECODE(JYSI_UM_CD,0,1,1,2),CTSHK_FLG,DECODE(MESI_KBN,0,1,9,2),SORT_KEIJ_YM,SWK_KBN,SIWAKE_GYO \n");
		
		// 2021/10/18 arai 追加  end
		
// 2020/05/22 ADD SQL END
		
		// 2020/05/22 ADD TEST START
		//System.out.println("SQL Siwake out start");
		System.out.println(sql);
		//System.out.println("SQL Siwake out end");
	...
	public String getMesiKbn() {
		return super.getString("MESI_KBN");
	}
	// 2020/05/22 ADD END
