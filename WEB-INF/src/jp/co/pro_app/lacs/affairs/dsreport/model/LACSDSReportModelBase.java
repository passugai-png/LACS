 ...
 * @version 20070817
 */
public abstract class LACSDSReportModelBase extends LACSSessionDBModelBase {
	...
	public void performSub() throws Exception {
		...
		LACSDSReportBean printBean = super.getDSReportBean();
		this.start(printBean);

		commonBean.setDispID("R003");
		...
		super.setForwardPath("/jsp/R003.jsp");
		super.getLogger().end();
	}
	 ...
	 *            帳票出力Bean
	 */
	protected final void init(LACSDSReportBean piReportBean) {
	 ...
	 *             SQL実行例外
	 */
	protected void prepareComoboBox(LACSDSReportBean piReportBean) throws SQLException {
