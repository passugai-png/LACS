...
public abstract class LACSReportPDFWriterBase {
	 ...
	 *             例外発生時.
	 */
	protected void businessProc(LACSSyousaiBean piSyousai) throws Exception {
		return;
	}
	 ...
	 *            契約詳細Bean
	 */
	protected void initSub(LACSSyousaiBean piSyousai) {
		return;
	}
	 ...
	 *                SQL実行例外
	 */
	protected abstract void getData(LACSSyousaiBean piSyousai) throws SQLException;
	 ...
	 *                SQL実行例外
	 */
	protected abstract ArrayList<Object> getData2(LACSSyousaiDetailBean piSyousaiDetail) throws SQLException;
	 ...
	 *                実行例外
	 */
	protected String makePDF(LACSSyousaiBean piSyousai, String piDateMode, ServletContext piContext) throws Exception {
		return "";
	}
